...
$products = query("SELECT * FROM products
                    ...
                    WHERE products.product_id = 'MC-01' OR 
                          products.product_id = 'OH-05' OR 
                          products.product_id = 'BC-05'");
...
<html lang="en">
  <head>
    ...
    <title>OISHIIKE-KI | Toko Kue</title>
  ...
  <body class="body">
      ...
      <div id="hero-carousel" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active c-item">
            <img src="assets/image/hero1.jpg" class="d-block w-100 c-img" alt="slide1">
            <div class="carousel-caption text-start top-0">
              <h1>Get Your Sweet Cake</h1>
              <p>Some representative placeholder content for the second slide.</p>
              <a href="menu.php" class="buy-now shadow">BUY NOW</a>
            </div>
          </div>
          <div class="carousel-item c-item">
            <img src="assets/image/hero2.jpg" class="d-block w-100 c-img" alt="slide2">
            <div class="carousel-caption text-start top-0">
              <h1>Get Your Sweet Cake</h1>
              <p>Some representative placeholder content for the second slide.</p>
              <a href="menu.php" class="buy-now shadow">BUY NOW</a>
          ...
          <div class="carousel-item c-item">
            <img src="assets/image/hero3.jpg" class="d-block w-100 c-img" alt="slide3">
            <div class="carousel-caption text-start top-0">
              <h1 class="light">Get Your Sweet Cake</h1>
              <p class="light">Some representative placeholder content for the second slide.</p>
              <a href="menu.php" class="buy-now shadow light">BUY NOW</a>
            </div>
          </div>
        </div>
      ...
      <!-- start our menus -->
      <div class="container-fluid cont-menus">
        <div class="row our-menus" id="our-menus">
          <h3>Our Menus</h3>
          <!-- start card -->
        ...
        <a href="menu.php" class="btn-view-product shadow">VIEW ALL PRODUCTS</a>
      </div>
      <!-- end our menus -->
      ...
      <div class="container about-us" id="about-us">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 paragraf">
            <img src="assets/image/about.jpg" class="img-thumbnail" alt="">
          </div>
        </div>
      </div>
      <!-- end about us -->
      ...
      <div class="row contact-us" id="contact-us">
        ...
        <div class="col-md-6 map text-center">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15812.774076110172!2d110.36849855!3d-7.7692928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59b2d4729729%3A0xac4d7b5fcf34f8e4!2sUniversitas%20Gadjah%20Mada!5e0!3m2!1sid!2sid!4v1717690473307!5m2!1sid!2sid" 
          height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div class="col-md-6 text-center form-contact">
